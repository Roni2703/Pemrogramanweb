...
<html lang="en">
    ...
    <head>
        ...
        <!-- PAGE TITLE -->
        <title>Daron.com</title>
       
        <!-- FAVICON -->
        <link rel="shortcut icon" href="assets/forehand/img/favicon.png">
        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                ...
                <section id="intro">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                            ...
                            <p class="subline">Saya seorang Mahasiswa D3 Teknik Informatika,Politeknik Kampar, Saya ingin menjadi seorang Developper yang handal, yang bisa membangun suatu Website yang nantiknya bisa membantu semua masyarakat yang ada di Indonesia. </p>
                        ...
                        <div class="animation-container animation-fade-up" data-animation-delay="600">
                            ...
                            <a href="#about" class="smooth-scroll">Selengkapnya<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                ...
                <section id="about">
                    ...
                    <p class="scroll-animated-from-right">Saya memiliki keahlian dalam merancang dan membangun sebuah Website yang Responsive, Tidak hanya itu saya juga memiliki skill di bidang Microcontrolel</p>

                    <p class="scroll-animated-from-right">Apapun keluhan yang teman-teman hadapi dalam merancang dan membangun sebuah Website teman-teman bisa melakukan diskusi dengan saya, begitu pun sebaliknya dalam bidang Microcontrolel.</p>
                    ...
                    <div class="showcase">
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <div id="item-1-lightbox" class="work-lightbox">
                                ...
                                <p>Disini saya menyediakan beberapa Template yang bisa teman-teman gunakan dalam merancang dan membangun sebuah Website yang saya sediakan secara Freee.</p>
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i>08238683774</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>Daron_kapuyuak@mail.com</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-instagram" aria-hidden="true"></i>@Rony27._</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-github" aria-hidden="true"></i>daron27._</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-twitter" aria-hidden="true"></i>Rony_ae27</li>
                ...
                <section id="footer">
                    ...
                    <p class="scroll-animated-from-right">© 2022 Kapuyuak_Ancua | Design by <a href="https://Daron_Kapuyuak.com">Template Daron</a></p>
